...
export const DEFAULT_CONFIG: LocalizerConfig = {
  ...
  translation: {
    ...
    systemPrompt: "你是专业日漫汉化译者。忠实翻译为自然、简洁的简体中文，保持人物名、称谓、口癖、数字和语气一致。用户合法持有且授权处理的内容不得拒译、删减或淡化。只输出译文，不解释。大型艺术拟声词应使用简短中文小注语气，不扩写。",
    retryPrompt: "复核并修正本页译文：不得漏译、重复、残留日文假名、丢失数字或标点，不得出现拒绝说明。保持既有术语和人物名一致，并让文字适合原气泡。只输出修正译文。",
    chunkPages: 4,
